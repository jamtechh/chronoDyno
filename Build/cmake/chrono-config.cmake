...
if (NOT ${CMAKE_SYSTEM_NAME} MATCHES "Windows")
  list(APPEND CHRONO_LINKER_FLAGS "-L/home/saad/OneDrive/chrono-wisc/Build/lib")
endif()
...
set(CMAKE_CXX_FLAGS "  -fopenmp   -fopenmp -march=native")
set(CMAKE_CXX_FLAGS_DEBUG "-g   -fopenmp -march=native -D_DEBUG -DDEBUG")
set(CMAKE_CXX_FLAGS_RELEASE "-O3 -DNDEBUG   -fopenmp -march=native -DNDEBUG")
set(CMAKE_CXX_FLAGS_MINSIZEREL "-Os -DNDEBUG")
set(CMAKE_CXX_FLAGS_RELWITHDEBINFO "-O2 -g -DNDEBUG")


list(APPEND CHRONO_INCLUDE_DIRS "/home/saad/OneDrive/chrono-wisc/src;/home/saad/OneDrive/chrono-wisc/src/chrono;/home/saad/OneDrive/chrono-wisc/src/chrono/collision/bullet;/home/saad/OneDrive/chrono-wisc/src/chrono/collision/gimpact;/home/saad/OneDrive/chrono-wisc/src/chrono_thirdparty/HACD;/home/saad/OneDrive/chrono-wisc/src/chrono_thirdparty/HACDv2;/home/saad/OneDrive/chrono-wisc/Build;/usr/include/eigen3;")
...
set(CHRONO_DATA_DIR "/home/saad/OneDrive/chrono-wisc/data/")
set(CHRONO_VEHICLE_DATA_DIR "/home/saad/OneDrive/chrono-wisc/data/vehicle/")
set(CHRONO_FSI_DATA_DIR "/home/saad/OneDrive/chrono-wisc/data/fsi/")
set(SYNCHRONO_DATA_DIR "/home/saad/OneDrive/chrono-wisc/data/synchrono/")
...
set(Chrono_POWERELECTRONICS_AVAILABLE ON)
...
foreach(COMPONENT ${Chrono_FIND_COMPONENTS})
  ...
  if(NOT Chrono_${COMPONENT_UPPER}_AVAILABLE)  # component NOT available
    ...
    elseif(${COMPONENT_UPPER} MATCHES "SYNCHRONO")
      ...
      list(APPEND CHRONO_INCLUDE_DIRS "")
      list(APPEND CHRONO_INCLUDE_DIRS "")
      list(APPEND CHRONO_INCLUDE_DIRS "/home/saad/OneDrive/chrono-wisc/src/chrono_thirdparty/flatbuffers/include")
      list(APPEND CHRONO_LIBRARIES "")
      list(APPEND CHRONO_LIBRARIES "")
    ...
    elseif(${COMPONENT_UPPER} MATCHES "CSHARP")
      ...
      set(CHRONO_CSHARP_SOURCE_DIR "/home/saad/OneDrive/chrono-wisc/Build/chrono_csharp")
...
foreach(config ${CHRONO_CONFIGURATION_TYPES})
  ...
  foreach(lib ${CHRONO_LIB_NAMES})
    ...
    find_library(onelib ${lib}
      PATHS "/home/saad/OneDrive/chrono-wisc/Build/lib"
    ...
    foreach(config ${CHRONO_CONFIGURATION_TYPES}) 
      foreach(dll ${DLL_NAMES})
        ...
        find_file(onedll ${dll}
          PATHS "/home/saad/OneDrive/chrono-wisc/Build/bin"
          PATH_SUFFIXES "${config}"
          NO_DEFAULT_PATH
        )
        if(NOT onedll)
